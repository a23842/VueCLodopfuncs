(function (win) {
        var CLODOP = {
        strWebPageID:"D63AAAP",strTaskID:"",strHostURI:"http://192.168.2.176:8000",
        VERSION:"6.2.2.6",IVERSION:"6226",CVERSION:"3.0.9.2",HTTPS_STATUS:0,VERSION_EXT:false,
                ...
                function() {
                        ...
                        try {
                                if (!this.webskt || this.webskt.readyState==3) {
                                        ...
                                        this.webskt=new WebSocket('ws://192.168.2.176:8000/c_webskt/');
